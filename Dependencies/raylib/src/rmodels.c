...
void DrawCubeTextureRec(Texture2D texture, Rect source, Vector3 position, float width, float height, float length, Color color)
{
    float x = position.x;
    float y = position.y;
    float z = position.z;
...
void DrawBillboardRec(Camera camera, Texture2D texture, Rect source, Vector3 position, Vector2 size, Color tint)
{
...
void DrawBillboardPro(Camera camera, Texture2D texture, Rect source, Vector3 position, Vector3 up, Vector2 size, Vector2 origin, float rotation, Color tint)
{
